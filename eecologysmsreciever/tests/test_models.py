...
class RawMessageTest(TestCase):
    ...
    def test_from_request(self):
        ...
        self.assertEqual(
            message.body, 'ID1608,4108,0000,10101719,25,00820202020204020200,14261,45780,49842689,524984249,14261,45480,49841742,524983380,14261,45300,49842004,524983903')
...
class MessageTest(TestCase):
    ...
    def test_fromBody_debug1gps(self):
        ...
        body = u'ID1608,4108,0000,10101719,25,00820202020204020200,14261,45780,49842689,524984249'
    ...
    def test_fromBody_debug3gps(self):
        ...
        body = u'ID1608,4108,0000,10101719,25,00820202020204020200,14261,45780,49842689,524984249,14261,45480,49841742,524983380,14261,45300,49842004,524983903'
